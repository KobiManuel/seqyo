...
const testimonials = [
  {
    quote:
      "SEQYO caught a sophisticated supply-chain attack that our previous SIEM completely missed. The expert network connected us with a specialist within 4 minutes.",
    name: "Sarah Chen",
  ...
  {
    quote:
      "We replaced three separate tools with SEQYO. Our security posture improved dramatically while our team&rsquo;s workload dropped by 60%. The ROI was instant.",
  ...
  {
    quote:
      "The compliance automation alone saved us 200+ hours per quarter. SEQYO makes our SOC 2 audits feel effortless now.",
    name: "Priya Mehta",
        ...
        <div className="text-center mb-14">
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-14">
            {[
              ...
              <span
                key={name}
                className="text-white/25 font-display text-xl font-bold tracking-wide hover:text-white/50 transition-colors"
              >
                {name}
              </span>
            ))}
        ...
        <div className="stats-row grid grid-cols-2 md:grid-cols-4 gap-6 mb-20">
          {stats.map(({ value, label }) => (
            <div key={label} className="stat-item text-center">
              <div className="font-display text-5xl md:text-6xl font-bold text-green-bright mb-2">
                {value}
              </div>
