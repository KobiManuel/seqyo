...
export default function ContactPage() {
  ...
  const [form, setForm] = useState({ name: '', email: '', company: '', role: '', message: '', interest: 'demo' })
  ...
  const contactInfo = [
    { icon: Mail, label: 'Email us', value: 'hello@seqyo.io', href: 'mailto:hello@seqyo.io' },
    { icon: Phone, label: 'Call us', value: '+1 (888) 473-7961', href: 'tel:+18884737961' },
    { icon: MapPin, label: 'HQ', value: 'San Francisco, CA · London, UK', href: '#' },
  ]
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="contact-hero">
              ...
              <p className="text-white/50 text-base leading-relaxed mb-12 max-w-md">
                Whether you want a demo, have a security emergency, or just want to learn how SEQYO can help — we're here. A real human will respond within 2 hours.
              </p>
                ...
                {contactInfo.map(({ icon: Icon, label, value, href }) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-white font-medium text-sm group-hover:text-green-bright transition-colors">{value}</div>
                    </div>
                  </a>
                ))}
              </div>
              ...
              <div className="glass rounded-2xl p-6">
                <p className="text-white/30 text-xs uppercase tracking-widest mb-4">Security & compliance</p>
                <div className="flex flex-wrap gap-3">
                  {['SOC 2 Type II', 'ISO 27001', 'GDPR Ready', 'HIPAA Compliant', 'PCI-DSS'].map((badge) => (
                    <span key={badge} className="bg-green-accent/10 border border-green-accent/20 text-green-bright/80 text-xs px-3 py-1.5 rounded-full">
                      {badge}
                    </span>
                  ))}
                </div>
              ...
              {submitted ? (
                <div className="text-center py-16">
                  ...
                  <p className="text-white/50 text-sm">
                    A member of our team will be in touch within 2 hours. In the meantime, check out our security resources.
                  </p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-5">
                  <h2 className="font-display text-2xl font-bold text-white mb-2">Send us a message</h2>
                  <p className="text-white/40 text-sm mb-6">Fill out the form and we'll get right back to you.</p>

                  {/* Interest toggle */}
                  <div>
                    <label className="text-white/50 text-xs uppercase tracking-wider mb-2 block">I'm interested in</label>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="text-white/50 text-xs uppercase tracking-wider mb-1.5 block">Work email *</label>
                      <input
                        type="email"
                        required
                        value={form.email}
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="text-white/50 text-xs uppercase tracking-wider mb-1.5 block">Company</label>
                      <input
                        type="text"
                        value={form.company}
                    ...
                    <div>
                      <label className="text-white/50 text-xs uppercase tracking-wider mb-1.5 block">Your role</label>
                      <input
                        type="text"
                        value={form.role}
